...
if hostname == "p4campus-proc1":
    fp_port_configs = [('5/0', '10G', 'NONE', 2), # lumos ens3f1 
                    ('6/0', '10G', 'NONE', 2), # caelus enp177s0f1 
                    ('1/0', '10G', 'NONE', 0), # loopback link1
                    ('2/0', '10G', 'NONE', 0), # loopback link1
                    ('12/0', '10G', 'NONE', 0), # to sender (tofino1a)
                    ('23/0', '10G', 'NONE', 0), # to receiver (tofino1c)
                    ]
else:
