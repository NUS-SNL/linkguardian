...
RESUME_THRESHOLD_CELLS = 622  # OLD: 140
PAUSE_THRESHOLD_CELLS = 662  # expected max = 840 (observed 680)@100G # OLD: 180
...
devtest_cmds_file = "/home/sigcomm23ae/linkguardian/switch_impl/system_impl/receiver/devtest_cmds_10g.py"
...
port_metadata_tbl = bfrt.receiver_10g.pipe.SwitchIngressParser.PORT_METADATA
...
l2_forward = bfrt.receiver_10g.pipe.SwitchIngress.l2_forward
...
leading_ack_max_notify = bfrt.receiver_10g.pipe.SwitchEgress.get_leading_ack_notify_max_count
...
tbl_courier_pkt_mirror_sessions = bfrt.receiver_10g.pipe.SwitchEgress.get_courier_pkt_mirror_session
...
tbl_generate_loss_notification = bfrt.receiver_10g.pipe.SwitchIngress.generate_loss_notification
...
for port in rx_dev_ports_to_protect:
    if ENABLE_PFC_ON_LOSS_NOTI:
        ...
        # tbl_add_pause_quanta = bfrt.receiver_10g.pipe.SwitchEgress.add_pause_quanta
...
#####################################
tbl_add_pfc_hdr_and_route = bfrt.receiver_10g.pipe.SwitchIngress.add_pfc_hdr_and_route
...
exec(code)
print("devtest_cmds_10g.py loaded!")
