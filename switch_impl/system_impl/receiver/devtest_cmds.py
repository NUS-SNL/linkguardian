...
reg_expected_seq_no = bfrt.receiver.pipe.SwitchIngress.reg_expected_seq_no
reg_ig_debug_counter = bfrt.receiver.pipe.SwitchIngress.reg_debug_counter
reg_eg_debug_counter = bfrt.receiver.pipe.SwitchEgress.reg_debug_counter
reg_leading_ack = bfrt.receiver.pipe.SwitchEgress.reg_leading_ack
reg_leading_ack_era = bfrt.receiver.pipe.SwitchEgress.reg_leading_ack_era
reg_leading_ack_notify_count = bfrt.receiver.pipe.SwitchEgress.reg_leading_ack_notify_count
reg_ack = bfrt.receiver.pipe.SwitchIngress.reg_ack
reg_ack_era = bfrt.receiver.pipe.SwitchIngress.reg_ack_era
era_correction = bfrt.receiver.pipe.SwitchIngress.era_correction
ig_debug_counter = bfrt.receiver.pipe.SwitchIngress.ig_debug_counter
emulate_random_pkt_drop = bfrt.receiver.pipe.SwitchIngress.emulate_random_pkt_drop
cntr_ig_debug = bfrt.receiver.pipe.SwitchIngress.ig_debug_counter
cntr_ig_debug2 = bfrt.receiver.pipe.SwitchIngress.ig_debug_counter2
reg_hole_sizes = bfrt.receiver.pipe.SwitchIngress.reg_hole_sizes
cntr_eg_debug = bfrt.receiver.pipe.SwitchEgress.eg_debug_counter
...
reg_pfc_curr_state = bfrt.receiver.pipe.SwitchEgress.reg_pfc_curr_state
reg_pfc_gen_req = bfrt.receiver.pipe.SwitchEgress.reg_pfc_gen_req
tbl_add_lack_hdr_or_drop_mirror_courier_pkt = bfrt.receiver.pipe.SwitchEgress.add_lack_hdr_or_drop_mirror_courier_pkt
tbl_add_pfc_c1_quanta = bfrt.receiver.pipe.SwitchEgress.add_pfc_c1_quanta # loss noti pfc
try:
    reg_lost_timestamps = bfrt.receiver.pipe.SwitchIngress.reg_lost_timestamps
except:
    pass
...
reg_qdepth_record_idx = bfrt.receiver.pipe.SwitchEgress.reg_qdepth_record_idx
reg_qdepth_records = bfrt.receiver.pipe.SwitchEgress.reg_qdepth_records
...
# reg_pkt_records = bfrt.receiver.pipe.SwitchIngress.reg_pkt_records
# reg_pkt_record_idx = bfrt.receiver.pipe.SwitchIngress.reg_pkt_record_idx
